...
# Your API key (set env var LLM_API_KEY or GROQ_API_KEY)
LLM_API_KEY = os.environ.get("LLM_API_KEY", os.environ.get("GROQ_API_KEY", ""))  # <-- PUT YOUR API KEY HERE OR IN ENV

# Model to use (leave empty for default, or specify like "gpt-4o", "claude-3-5-sonnet-20241022", etc.)
LLM_MODEL = "qwen/qwen3.6-27b"  # <-- Optional: specify model or leave empty for default
